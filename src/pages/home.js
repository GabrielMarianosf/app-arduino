...
import agua from "../../assets/android/drawable-xxxhdpi/agua.gif";
import sol from "../../assets/android/drawable-xxxhdpi/sol.gif";
import molhando from "../../assets/android/drawable-xxxhdpi/molhando.gif";
        ...
        },
        {
          ...
          onPress: () => {
            ...
            if (result) {
              ...
              Alert.alert(
                "AVISO !",
                "Falha ao Deletar o Sensor, Verifique se está conectado a internet ( 📶 )"
              );
            }
          },
        },
      ...
      return (
        <View style={{ paddingBottom: 5 }}>
          <View style={styles.viewsensor}>
            <Text style={{ padding: 3, top: -5 }}>
              {" "}
              Sensor: {obj.obj.sensor}
            </Text>
            ...
            <Text style={{ padding: 3, top: -5 }}>
              {" "}
              Última Atualização: {obj.obj.ultima_data}
            </Text>
            <View
              style={{
                width: 50,
      ...
      <View style={styles.container}>
        <View style={styles.loader}>
          ...
          <Text style={{ textAlign: "center", paddingTop: 20 }}>
            Se estiver demorando muito, verifique se está conectado na internet.
            ( 📶 )
          </Text>
        </View>
      </View>
