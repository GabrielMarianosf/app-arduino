  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <Text></Text>
        <Text> IP: </Text>
        <TextInput style={styles.input} placeholder=" Ex.: 123.456.78.90" />
        <Text></Text>
        <Text> Porta: </Text>
        <TextInput style={styles.input} placeholder=" Ex.: 1234" />
        <Text></Text>
        <Text style={styles.titleEsq}> Sensores</Text>
        <Text></Text>
        <Text> Nível Mínimo: </Text>
        <TextInput style={styles.input} placeholder=" Ex.: 50" />
        <Text></Text>
        <Text style={styles.titleEsq}> Parâmetros</Text>
        <Text></Text>
        <Text> Parâmetro 1: </Text>
        <TextInput style={styles.input} placeholder=" Ex.: Z" />
